...
func NewNodeReconciler(mgr manager.Manager, identifier fallbackidentity.Identifier) (*NodeReconciler, error) {
	r := &NodeReconciler{
...
type NodeReconciler struct {
	...
	identifier fallbackidentity.Identifier
}
...
func (r *NodeReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	labels, err := r.identifier.IdentifyNode(ctx, node)
	if err != nil {
